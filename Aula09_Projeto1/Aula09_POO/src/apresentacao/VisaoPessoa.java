...
// Métodos  Construtor da Classe
		   ...
		   public VisaoPessoa() {
		      ...
		      // -> Configuração do Endereço
		        ...
		        btnLimpar.addActionListener(new ControladorLimpar(txtNome, optMasculino, txtEndereco, cboUf)); // nn precisa do nabinarie pq se não for masculino ele vai pro feminio, se nao for feminino ele já vai pro naobinarie, se nao tivesse o nao binarie, eu so colocaria o masculino pq se não fosse masculino ele ia direto para o feminino.
